...
/** Reusable canvas-space quad whose corners are supplied per tile. */
class TileQuadGeometry {
    ...
    fun draw(left: Int, top: Int, right: Int, bottom: Int) {
        check(vaoId != 0)
        ...
        val data = ByteBuffer.allocateDirect(values.size * Float.SIZE_BYTES)
