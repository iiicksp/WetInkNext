...
data class BrushSettings(
    ...
    val smoothing: Float = 0f, val streamline: Float = 0f, val antiAliasLevel: Int = 2, val useTempStrokeBuffer: Boolean = false,
    ...
    val rotationJitter: Float = 0f, val sizeJitter: Float = 0f, val opacityJitter: Float = 0f, val scatter: Float = 0f,
